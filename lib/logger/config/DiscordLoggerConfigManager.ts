...
export class DiscordLoggerConfigManager {
  public async create({ guildID, logChannelIDs, modRoleID }: Partial<IDiscordLoggerConfig>): Promise<void> {
    try {
      const cfg = new DiscordLoggerConfig({ guildID, logChannelIDs, modRoleID });
